...
import static com.laioffer.jupiter.servlet.ServletUtil.readRequestBody;
...
//        FavoriteRequestBody body = new ObjectMapper().readValue(request.getReader(), FavoriteRequestBody.class);
        FavoriteRequestBody body = readRequestBody(FavoriteRequestBody.class, request);
        if (body == null) {
