...
public class TwitchClient {
    private static final String TOKEN = "Bearer 6ew3vnw49b0st77lr8x9xssrw42ruh";
    private static final String CLIENT_ID = "12v9b5vf51hk87g39cmyiipktseqc3";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        try {
            ...
            return httpclient.execute(request, responseHandler);// the get request body
        } catch (IOException e) {
            e.printStackTrace();
            throw new TwitchException("Failed to get result from Twitch API");
        } finally {
